...
public class FragmentTCash extends Fragment {
	static ListView l;
	public static Button pay;
	public static TextView gross;
	public static EditText tNumber_;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.fragment_tcash, container,
				false);
		...
		tNumber_ = (EditText) v.findViewById(R.id.tNumber_);
		gross.setText("" + FragmentHome.gross.getText());
		getActivity().getActionBar().setTitle("Telkomsel Cash");
	...
	private class PayButtonListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			tNumber = tNumber_.getText().toString();
			Time now = new Time();
			now.setToNow();
